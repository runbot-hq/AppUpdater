...
extension AppUpdater {
    ...
    public func scheduleBackgroundCheck(state: any UpdateStateProviding) { // skipcq: SW-R1002 — reviewed; complexity acceptable for this scheduler setup
        ...
        scheduler.schedule { completion in
            ...
            //
            // automaticUpdatesEnabled is checked inside checkAndHandle (the central
            // gate in AppUpdater+UpdateFlow.swift). When false, checkAndHandle
            // returns immediately and this scheduler cycle becomes a no-op.
            // The scheduler lifecycle is not affected (#2501).
            Task { @MainActor in
