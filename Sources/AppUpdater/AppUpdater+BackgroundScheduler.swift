...
extension AppUpdater {
    ...
    public func scheduleBackgroundCheck(state: any UpdateStateProviding) { // skipcq: SW-R1002 — reviewed; complexity acceptable for this scheduler setup
        ...
        scheduler.schedule { completion in
            ...
            //
            // automaticUpdatesEnabled is checked at the top of the Task body.
            // When false the Task returns immediately; the scheduler lifecycle
            // is not affected — see AppUpdater.automaticUpdatesEnabled doc comment.
            Task { @MainActor in
